...
export const metadata: Metadata = {
  title: "Heat Pump Water Heater Repair & Installation | Energy Efficient",
  ...
  openGraph: {
    title: "Heat Pump Water Heater Repair & Installation",
  ...
  alternates: {
    canonical: "https://waterheatersos.com/heat-pump-water-heaters",
  },
};
