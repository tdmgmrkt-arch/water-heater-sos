  ...
  return (
    <html lang="en">
      <head>
        ...
        <Script
          async
          src="https://www.googletagmanager.com/gtag/js?id=AW-16844064763"
        ...
        <Script id="google-tag-manager" strategy="afterInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-PBSQZB4X');
          `}
        </Script>
      </head>
      <body className="antialiased">
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-PBSQZB4X"
            height="0"
            width="0"
