            ...
            {[
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  <AlertCircle className="h-4 w-4 sm:h-5 sm:w-5 text-[#EA5D19]" />
      ...
      <section className="py-10 sm:py-16 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-xl sm:text-3xl font-bold tracking-tight text-gray-900 mb-4">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base sm:text-xl text-gray-600">
              Common questions from Rancho Cucamonga homeowners
            </p>
          </motion.div>
          ...
          <Accordion type="single" collapsible className="space-y-2 sm:space-y-4">
            <AccordionItem value="item-1" className="border rounded-lg px-4 sm:px-6 bg-gray-50">
              ...
              <AccordionContent className="text-gray-600 text-xs sm:text-sm lg:text-base leading-relaxed pb-3 sm:pb-4">
                If your water heater is over 10 years old, leaking, making loud noises, or failing to heat water consistently, it may need repair—or replacement if the tank is corroded. Our technicians will assess your water heater and recommend the best option for your home and budget.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-2" className="border rounded-lg px-4 sm:px-6 bg-gray-50">
              ...
              <AccordionContent className="text-gray-600 text-xs sm:text-sm lg:text-base leading-relaxed pb-3 sm:pb-4">
                Tankless water heaters provide hot water on demand, saving energy and space. They last longer than traditional tank models—often over 20 years—and provide endless hot water. We'll help you choose the right size for your household's needs.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-3" className="border rounded-lg px-4 sm:px-6 bg-gray-50">
              ...
              <AccordionContent className="text-gray-600 text-xs sm:text-sm lg:text-base leading-relaxed pb-3 sm:pb-4">
                We offer same‑day service for most plumbing emergencies in Rancho Cucamonga and the surrounding areas. Call us at (800) 697‑4014, and we'll get a technician to you as soon as possible.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-5" className="border rounded-lg px-4 sm:px-6 bg-gray-50">
              <AccordionTrigger className="text-left text-sm sm:text-base lg:text-lg font-semibold hover:text-[#EA5D19] transition-colors py-3 sm:py-4">
                Can you help with hard water or water quality issues?
              </AccordionTrigger>
              <AccordionContent className="text-gray-600 text-xs sm:text-sm lg:text-base leading-relaxed pb-3 sm:pb-4">
                Absolutely. We install water filtration systems, water softeners, and reverse‑osmosis systems to remove contaminants, reduce mineral buildup, and improve the taste and safety of your tap water. We'll test your water and recommend the best solution for your needs.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
