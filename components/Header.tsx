...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-[60] w-full bg-[#11110E]">
      
      {/* ⭐ MAIN NAVBAR ⭐ */}
      <div className="border-b border-white/10 bg-gradient-to-r from-[#11110E] via-[#1A1A17] to-[#11110E]">
        <Container>
          <div className="flex h-20 items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-1.5">
              ...
              <a
                href="tel:8006974014"
                className="
                  ml-4 flex items-center gap-2 rounded-xl
            ...
            <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
              <SheetTrigger asChild className="lg:hidden">
                <Button className="rounded-xl text-white hover:bg-white/10" variant="ghost" size="icon">
        ...
        {activeMenu && (
          <motion.div
            ...
            className={`
              ...
              top-20 
              z-50 w-full border-t-2 border-[#EA5D19]
              bg-gradient-to-br from-[#11110E] via-[#1A1917] to-[#11110E]
          ...
          >
            ...
            {/* EVERYTHING IN YOUR ORIGINAL MEGA MENU IS KEPT **EXACTLY** */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div>
                      <div className="space-y-3 -ml-12">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <h3 className="font-bold text-lg text-white mb-1">{activeMenu}</h3>
                    ...
                    <div className="mt-4 pt-6 border-t border-white/10">
                      <div className="space-y-2">
                        ...
                        <a
                          href="tel:8006974014"
                          className="
                            flex items-center gap-2 text-[#EA5D19] font-bold text-lg 
                            hover:text-[#FF6E2E] transition-colors
                          "
                        >
                  ...
                  <div className="lg:col-span-9 relative flex flex-col h-full">
                    <div className="grid auto-rows-min grid-cols-2 gap-4 md:grid-cols-3 flex-1">
                      {menuStructure[
                        activeMenu as keyof typeof menuStructure
                        ...
                        return (
                          ...
                          >
                            <Link
                              ...
                              onClick={() => setActiveMenu(null)}
                              className={`
                                group relative flex items-start gap-3 rounded-xl px-4 py-4 h-full border
                            ...
                            >
                              {isFeatured && (
                                <div className="absolute -top-4 left-[18px] z-20">
                                  <span
                                    className="
                                      inline-flex items-center gap-1 rounded-md px-3 py-[2px]
                                      text-[10px] font-semibold text-[#EA5D19] uppercase tracking-wide
                                      bg-[#fffdf9]/95 shadow-[0_0_6px_rgba(234,93,25,0.35)]
                              ...
                              <div className="flex-1 min-w-0">
                                <span
                                  className={`
                                    block text-sm font-semibold transition-colors leading-tight
                                    ${
                                      isFeatured
                                        ? "text-white"
                    ...
                    <div className="mt-10 pt-8">
                      ...
                      <div className="
                        relative overflow-hidden flex flex-col sm:flex-row items-center 
                      ...
                      ">
                        ...
                        <div className="text-white relative z-10">
                          <p className="font-bold text-lg mb-1 flex items-center gap-2">
                            Ready to Get Started? <span className="inline-block animate-bounce-in">✨</span>
                          </p>
                        ...
                        <div className="flex gap-3 shrink-0 relative z-10">
                          <a
                            ...
                            className="
                              ...
                              bg-white px-6 py-3 text-sm font-bold text-[#EA5D19] 
                              hover:bg-gray-50 transition-all shadow-md hover:shadow-xl whitespace-nowrap hover-lift
                            "
                          >
                          ...
                          <Link
                            href="/quote"
                            className="
                              group flex items-center justify-center rounded-xl border-2 border-white 
                              px-6 py-3 text-sm font-bold text-white hover:bg-white/10 transition-all 
