        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A <Link href="/tankless-water-heaters" className="text-[#EA5D19] hover:underline font-semibold">tankless water heater</Link> from SOS Plumbing and Air delivers hot water fast. Most Temecula homes should have a tankless water heater to provide their families with endless hot water. Pair it with a <Link href="/water-filtration" className="text-[#EA5D19] hover:underline font-semibold">water filtration system</Link> for top performance.
            </p>
          </motion.div>
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Imagine a morning shower that never turns cold. With SOS Plumbing and Air, you get endless hot water and cleaner pipes. A filtration system protects your investment. It ensures every drop is pure. You enjoy better water and a reliable heater every day.
              </p>
