      ...
      <section className="py-10 sm:py-16 lg:py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="h-1 w-16 sm:w-20 bg-[#EA5D19] mx-auto rounded-full mb-4" />
      ...
      <section className="py-10 sm:py-16 bg-gradient-to-r from-[#EA5D19] to-[#FF6E2E]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-sm sm:text-lg text-white/90 mb-8 max-w-2xl mx-auto">
