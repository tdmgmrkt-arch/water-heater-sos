...
import { ArrowRight, Flame, Droplets, Zap, Droplet, Search, Check, Wind, Wrench, Phone } from "lucide-react";
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Contact Water Heater SOS today for expert service you can trust. Same-day appointments available!
            </p>
