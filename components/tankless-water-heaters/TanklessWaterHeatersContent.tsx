          ...
          <div className="grid gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            >
              ...
              Is your tankless water heater displaying an error code?
                <span className="hidden sm:inline"> Tankless water heaters are great because they are energy efficient and will last considerably longer than traditional tank water heaters.</span>
              </p>
