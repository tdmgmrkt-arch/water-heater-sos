      ...
      {/* Premium Section Header */}
        ...
        >
          ...
          <p className="text-sm sm:text-lg leading-relaxed text-gray-600 max-w-7xl mx-auto">
            <span className="hidden sm:inline">Most people just want to repair or replace their existing water heater with the same type they currently have. In most cases, this makes the most sense and is a cost effective way to restore your hot water. However, we can discuss energy efficient options.</span>
            <span className="sm:hidden">Repair or replace your water heater with fast, reliable service. We offer cost-effective solutions and energy efficient options.</span>
          </p>
        </motion.div>
              ...
              >
                <Link href={service.href} className="block group">
                  <div className="relative h-full rounded-2xl sm:rounded-3xl overflow-hidden card-elevated bg-white">
                    ...
                    <div className="relative h-52 sm:h-85 overflow-hidden">
                      <Image
                        src={service.image}
