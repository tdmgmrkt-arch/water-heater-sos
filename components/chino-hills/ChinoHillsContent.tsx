    ...
    <>
      ...
      <section className="py-10 sm:py-16 lg:py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-gray-900 mb-4">
            ...
            {[
              ...
              >
                <Link href={service.link}>
                  <div className="h-full rounded-xl sm:rounded-2xl bg-white p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 border border-gray-200">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="rounded-xl sm:rounded-2xl bg-gray-50 p-4 sm:p-6 border border-gray-200"
              >
      ...
      <section className="py-10 sm:py-16 lg:py-20 bg-gradient-to-r from-[#EA5D19] to-[#FF6E2E]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                <span className="sm:hidden">(800) 697-4014</span>
                <span className="hidden sm:inline">(800) 697-4014</span>
              </Link>
              <Link
                href="/quote"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <Accordion type="single" collapsible className="space-y-2 sm:space-y-4">
            <AccordionItem value="item-1" className="border rounded-lg px-4 sm:px-6 bg-gray-50">
              <AccordionTrigger className="text-left text-sm sm:text-base lg:text-lg py-3 sm:py-4 font-semibold hover:text-[#EA5D19] transition-colors">
                Can you install a new sewer line?
              </AccordionTrigger>
              <AccordionContent className="text-gray-600 text-xs sm:text-sm lg:text-base pb-3 sm:pb-4 leading-relaxed">
