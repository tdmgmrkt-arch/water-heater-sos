              ...
              >
                ...
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 mb-8">
                  ...
                  <p className="text-gray-700 leading-relaxed mt-4">
                    ...
                    <a href="https://sosplumbingandair.com/" className="text-[#EA5D19] hover:underline">
                      our website
                    </a>
                    .
                  </p>
                ...
                <div id="definitions" className="scroll-mt-24 mb-12">
                  ...
                  <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 space-y-4">
                    <div>
                      ...
                      <p className="text-gray-700">Service is the https://sosplumbingandair.com website operated by SOS Plumbing and Air.</p>
                    </div>
                    <div>
