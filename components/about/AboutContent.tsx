    ...
    <main className="min-h-screen bg-white">
            ...
            {[
              ...
              >
                <div className="mb-3 sm:mb-4 inline-flex rounded-lg bg-[#EA5D19] p-3">
                  <specialty.icon className="h-4 w-4 sm:h-6 sm:w-6 text-white" />
                </div>
                <h3 className="text-base sm:text-xl font-bold text-gray-900 mb-3">
                  {specialty.title}
                </h3>
                <p className="text-sm sm:text-base text-gray-600">{specialty.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-10 sm:py-16 lg:py-20 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl lg:text-4xl mb-2 sm:mb-4">
              Our Story
            </h2>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="bg-gradient-to-br from-gray-50 to-white p-4 sm:p-6 lg:p-10 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200"
          >
            <div className="flex items-center justify-center mb-6">
              <div className="text-3xl sm:text-5xl font-extrabold text-[#EA5D19]">2019</div>
            </div>
            <p className="text-sm sm:text-lg text-gray-700 leading-relaxed text-center mb-6">
            ...
            <p className="text-sm sm:text-lg text-gray-700 leading-relaxed text-center">
      ...
      <section className="py-10 sm:py-16 lg:py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            <div className="bg-white p-4 sm:p-6 lg:p-10 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200">
              <div className="text-center mb-6 sm:mb-8">
                <h3 className="text-2xl sm:text-3xl font-bold text-[#11110E] mb-2">Anna M.</h3>
                <p className="text-base sm:text-xl text-[#EA5D19] font-semibold">Founder & Owner</p>
              </div>
              <div className="space-y-4 sm:space-y-6 text-center">
                ...
                <div className="pt-4">
                  <blockquote className="text-base sm:text-xl italic text-gray-900 font-medium">
      ...
      <section className="py-10 sm:py-16 lg:py-20 bg-gradient-to-r from-[#EA5D19] to-[#FF6E2E]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="text-2xl font-bold tracking-tight text-white sm:text-3xl lg:text-4xl mb-4 sm:mb-6">
